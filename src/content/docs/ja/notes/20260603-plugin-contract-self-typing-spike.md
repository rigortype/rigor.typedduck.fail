---
title: "Typing plugin files against the `Plugin::Base` contract — spike findings"
description: "Imported from rigortype/rigor docs/notes/20260603-plugin-contract-self-typing-spike.md."
