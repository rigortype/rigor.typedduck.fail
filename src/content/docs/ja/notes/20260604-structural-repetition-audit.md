---
title: "構造的なコード重複の監査（非カタログ・非プラグイン） — 2026-06-04"
description: "rigortype/rigor docs/notes/20260604-structural-repetition-audit.mdの翻訳です。"
...
## テーマA — 値オブジェクトの`==`／`eql?`／`hash`／`inspect`／`to_h`ボイラープレート
