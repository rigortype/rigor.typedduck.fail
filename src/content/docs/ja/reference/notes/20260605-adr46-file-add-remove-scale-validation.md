---
title: "ADR-46 file add/remove — scale validation (real OSS libs)"
description: "Imported from rigortype/rigor docs/notes/20260605-adr46-file-add-remove-scale-validation.md."
