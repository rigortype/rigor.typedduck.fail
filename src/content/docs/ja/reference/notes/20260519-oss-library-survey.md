...
sourceSha: "98f5754d5ea79507b19d58ef374dada836ae74e7fb65de5d421a01a850a6bbe2"
...
`hamlit` + `haml`: 6回の`undefined method 'html_safe' for String`の出現。これはActiveSupportのcore_extメソッド。ユーザーは[`rigor-activesupport-core-ext`](../examples/rigor-activesupport-core-ext)プラグインを利用可能だが、デフォルトでは適用されない。3つのオプション:
