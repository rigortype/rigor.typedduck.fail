...
description: "rigortype/rigor docs/notes/20260518-matsumoto-2008-poly-records-rigor-review.mdの翻訳です。"
...
- [ADR-0: コンセプト](../../adr/0-concept/)
- [ADR-1: 型モデルとRBSスーパーセット戦略](../../adr/1-types/)
- [ADR-3: 内部型表現](../../adr/3-type-representation/)
- [ADR-5: ロバストネス原則](../../adr/5-robustness-principle/)
- [ADR-8: Steepにインスパイアされた改善](../../adr/8-steep-inspired-improvements/)
- [ADR-14: RBSシグネチャ生成](../../adr/14-rbs-sig-generation/)
- [RBS::Extendedアノテーション仕様](../../type-specification/rbs-extended/)
- [ロバストネス原則仕様](../../type-specification/robustness-principle/)
