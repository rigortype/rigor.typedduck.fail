...
- [`docs/notes/20260518-matsumoto-2010-cfa-rigor-review.md`](../../notes/20260518-matsumoto-2010-cfa-rigor-review/) — 松本＆南出2010のSemiRubyに対する半フロー感応CFA。*メソッド定義*のフロー感応性（値フロー感応性なし）が、それ自体として首尾一貫した設計選択であることを示す——Rigorの静的ディスパッチャ層は、これをキャッシュ親和性とRactor隔離と引き換えに近似している。
