...
sourceSha: "45d427507e627c7fa03f371b330eddd1d8087df3660dbaa3e45965b80ac43201"
...
Steepは`Slug#normalise`のボディをこのsigに対してチェックし、戻り型がずれるとエラーを出す。Rigorは`def.return-type-mismatch`ルール（第8章）の下で同じことをチェックする。両ツールとも契約（contract）で合意する。
