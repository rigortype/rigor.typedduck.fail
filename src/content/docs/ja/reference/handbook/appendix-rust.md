...
sourceSha: "0a7fe17f4de1bde8f567220a72a8b98d23fad09d00ba555f2a25d766a9cce0c2"
...
- **メンバー値がfoldされる**。 `Point.new(1, 2).x`は単なる`Integer`ではなく`Constant<1>`だ。Rustは構築時にリテラルを消去するが、Rigorは（foldingバジェットの範囲内で）それを保持する。
