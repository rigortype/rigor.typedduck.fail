...
サブタイピングとメソッド利用可能性は、Rigorが静的ファセット`T`を持つとき、それに対してチェックされます。動的値が型付き境界を越えることを可能にするのは、サブタイピングではなく漸進的一貫性です。[relations-and-certainty.md](../relations-and-certainty/)を参照してください。
