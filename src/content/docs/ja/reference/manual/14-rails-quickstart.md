...
sourceSha: "a6e6fa2ee1dfdd78696ae5d32ccfa33807973a1efb16887e64a3a42ff8a8ec02"
...
> **このガイドの内容**
> [開始前の確認](#開始前の確認) ·
> [ステップ1 · Ruby 4.0 + Rigorのインストール](#ステップ1--ruby-40とrigorのインストール両pathに共通) ·
> [Path A — project-initスキル](#path-a--rigor-project-initスキル推奨) ·
> Path B — [導入モード](#ステップ2--導入モードの選択) · [config作成](#ステップ3--rigordistymlの作成) · [最初の実行](#ステップ4--最初の実行) · [出力を読む](#ステップ5--出力の理解) · [ベースライン](#ステップ6--ベースラインの生成acknowledgeモード) · [コミット](#ステップ7--コミット) ·
> [次のステップ](#次のステップ)
