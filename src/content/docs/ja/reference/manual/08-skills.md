...
editUrl: "https://github.com/rigortype/rigor/edit/main/docs/manual/08-skills.md"
...
コールドスタートからプロジェクトをRigorにオンボードします。スタック（Rails、RSpec、dry-rb、…）を検出し、対応する[プラグイン](../07-plugins/)を提案し、採用モード——既存コードベース向けの[ベースライン](../06-baseline/)スナップショットまたはクリーンなコードベース向けのゼロ診断ゲート——を選択し、`.rigor.dist.yml`を書き出して最初のベースラインを生成します。
