...
sourceSha: "2e99e4092a28fab26c7cf95104cce450e4063e0d5b88d432a984035426a63f0e"
...
→ rigor-ci-setup: Rigor は設定済みだが CI に連携されていない。リグレッションガードを固定する。
  読み込み: rigor skill rigor-ci-setup
...
| **検出結果を見る** | なし | バグには`rigor check`、「ここに型を足そう」には`rigor coverage --protection`。 | [CLIリファレンス](../02-cli-reference/)、[型保護カバレッジ](../15-type-protection-coverage/) |
