...
const KEEP = ['プロデューサ', 'コンシューマ', 'ウォーカ', 'メンバ', 'ファミリ', 'レイヤ', 'ディスパッチャ', 'レシーバ', 'サーバ', 'エントリ', 'サマリ', 'カテゴリ', 'ファクトリ', 'ディスカバリ', 'アドバイザリ', 'トリガ', 'アナライザ', 'ビルダ', 'メンテナ', 'プレースホルダ', 'バインダ', 'マネージャ', 'コントローラ', 'ミューテータ', 'バリデータ', 'ラッパ', 'トレーラ', 'ダーティ', 'パブリッシャ'].sort((a, b) => b.length - a.length);
