...
const DROP = ['パラメーター', 'ハンドラー', 'クラスター', 'ポインター', 'フィルター', 'コンパイラー', 'コンストラクター', 'ジェネレーター', 'アクセサー', 'セレクター', 'プロセッサー', 'セパレーター', 'コンテナー', 'インタープリター', 'スケジューラー', 'リゾルバー', 'シリアライザー', 'コンビネーター', 'フォーマッター', 'アキュムレーター', 'スキャナー', 'ディスクリプター', 'エディター', 'パーサー', 'プロバイダー', 'ドライバー', 'カウンター', 'アダプター', 'リファクター', 'クロージャー', 'フィクスチャー', 'プロシージャー', 'インフラストラクチャー', 'イテレーター'].sort((a, b) => b.length - a.length);
